...
const basket = {};
// фунция вкл.выкл  отображение корзины 
...
// добавление данный в basket выброного товара
...
function renderProductInBasket(productId) {
    ...
    if (!basketRowEl) {renderNewProductInBasket(productId);
        return;
    }
...
function renderNewProductInBasket(productId) {
    const productRow = `<div class="basketRow" data-id="${productId}">
